		...
		<div class="admin-content am-animation-slide-right clearfix">
			...
			<div class="panel-body">
				<form id="mainForm" class="form-horizontal" role="form" method='post'>
					...
					<div class="form-group">
						<label class="col-md-2 control-label" for="userID">派出所地址:</label>
						<div class="col-md-7">                                                                             
							
							<input type="text" name="address" id="address" placeholder="" value="${model.entity.address}"  class="form-control" >
						</div>	
					</div>
