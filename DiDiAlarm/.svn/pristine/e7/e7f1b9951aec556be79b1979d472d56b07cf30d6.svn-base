	...
	<div id="page" style='top:${model.direct==1?0:'60px'}'>
		...
		<div class="admin-content am-animation-slide-right clearfix">
			<div style="padding:20px; ">
				<h2 style="color:#353535; display:inline;">公众信息 » 查看</h2>
			...
			<div class="panel-body">
				<form id="mainForm" class="form-horizontal" role="form" method='post'>
					...
					<div class="form-group">
						<label class="col-md-2 control-label" for="userID">登录名:</label>
						<input class="hidden" name="userID" id="userID" value="${model.entity.userID}">
						<div class="col-md-7">
							<input type="text" name="userName" id="userName" placeholder="" value="${model.entity.userName}"  class="form-control" readonly="readonly">
						</div>					
					</div>
						<div class="form-group">
						<label class="col-md-2 control-label">姓名:</label>
						<div class="col-md-7">
							<input type="text" name="realName" id="realName" placeholder="" value="${model.entity.realName}" class="form-control" readonly="readonly">
						</div>					
					</div>
						<div class="form-group">
						<label class="col-md-2 control-label">密码:</label>
						<div class="col-md-7">
							<input type="password" name="userPassword" id="userPassword" placeholder="" value="******" class="form-control" >
						</div>					
					</div>
						...
						<div class="col-md-7">
							<input type="password" name="confirmPassword" id="confirmPassword" placeholder="" value="${model.entity.confirmPassword}" class="form-control" >
						</div>					
					</div>
						...
						<div class="col-md-7">
							<input type="text" name="telephone" id="telephone" placeholder="" value="${model.entity.telephone}" class="form-control" readonly="readonly">
						</div>					
					</div>
 ...
 var 	editor =null;
	...
	$('#loading-waiting-modal').modal({closeViaDimmer:false});
		$.ajax({
			...
			if(data.error==null)
				handsuc(data, 'update', 'member.do?p=view&moduleID=${model.chooseModuleID}&parentID=${model.chooseParentID}&direct=${model.direct}');
			else
				handerr(data);	
			},
