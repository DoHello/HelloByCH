		...
		<div id="pageBody" class="scrollbar-hover">
			...
			<div class="admin-content am-animation-slide-right clearfix">
				<div style="padding:20px; ">
					<h2 style="color:#353535; display:inline;">系统管理 » 警情推送设置</h2>
				...
				<div style="padding:10px; ">
					<div class="panel">
						...
						<label class="col-md-2 control-label" data-toggle="tooltip" title="该人数为系统自动推送模式下，&#13;&#10;按由近及远、单个推送的原则将警情推送至警员端的最多人数，&#13;&#10;当推送达到该值后，将会提醒公众端用户当前没有空闲警员，&#13;&#10;将通过指挥中心调派。">至多推送警员人数</label>
						<div class="col-md-7">
							<input type="text" name=policejPushPeople id="policejPushPeople" placeholder="推送人个数" value="${model.jPush.policejPushPeople}" class="form-control" required>
								...
								<div class="form-group">
						<label class="col-md-2 control-label" data-toggle="tooltip" title="在系统自动模式下，警情推送至警员端后，&#13;&#10;如果该警员端间隔N分钟未进行处理，将会推送至下一个警员。">推送最近警员的时间间隔(分钟)</label>
						<div class="col-md-7">
						...
						<div class="form-group"><label>         注：系统自动推送模式：该模式下,系统会将警情推送至距报警地最近的警员的客户端上，如果该警员在超时时间内未作任何操作，将推送至下一个次最近警员，以此类推，直至达到改 模式下所设置的至多推送警员人
</label></div>
