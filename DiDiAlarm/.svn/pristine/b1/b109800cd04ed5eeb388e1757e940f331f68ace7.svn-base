	...
	<div id="page" style='top:${model.direct==1?0:'60px'}'>
		...
		<div class="admin-content am-animation-slide-right clearfix">
			<div style="padding:20px; ">
				<h2 style="color:#353535; display:inline;">职务管理 » 模块与按钮权限</small></h2>
			</div>
			...
			<div style="padding:10px; ">
				<div class="row">
					<div class="col-md-2">
						<select name="appPlatform" id="appPlatform" data-placeholder="系统" class="chosen-select form-control" tabindex="2">
				...
				<div style="margin-top:-1px;">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="btn-group">
								<button id="btnAdd" class="btn btn-xs">新增按钮</button>
								<button id="btnEdit" class="btn btn-xs">修改按钮</button>
