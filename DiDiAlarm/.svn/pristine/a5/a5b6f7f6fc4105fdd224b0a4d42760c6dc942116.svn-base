...
<head>
	<title>DIDI报警后台管理系统</title><meta charset="UTF-8" />
...
<body>
<div style="width:100%;height:100%;text-align: center;margin: 0 auto;position: absolute;background-image: url('login/back.jpg');">
	<div id="loginbox">
