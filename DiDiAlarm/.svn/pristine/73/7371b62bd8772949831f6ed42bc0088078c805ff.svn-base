...
<!-- <link rel="stylesheet" type="text/css" href="js/chosen_v1.4.2/docsupport/*.css"/> -->
<!-- <link rel="stylesheet" type="text/css" href="js/chosen_v1.4.2/*.css"/> -->
<!-- <script type='text/javascript' src='js/chosen_v1.4.2/docsupport/*.js'></script> -->
<!-- <script type='text/javascript' src='js/chosen_v1.4.2/*.js'></script> -->
	...
	<div id="page" style='top:${model.direct==1?0:'60px'}'>
		...
		<div class="admin-content am-animation-slide-right clearfix">
			<div style="padding:20px; ">
				<h2 style="color:#353535; display:inline;">系统配置管理» 新增</h2>
			...
			<div class="panel-body">
				<form id="mainForm" class="form-horizontal" role="form" method='post'>
					<div class="form-group">
						...
						<input class="hidden" name="dicID" >
						<div class="col-md-7">
							<input type="text" name="dicName" id="dicName" placeholder="字典名称" value="" class="form-control" required>
						</div>
					</div>
	...
	$("#btnCommit").click(function() {
		...
		$.ajax({
			...
			success: function(data) {
				handsuc(data, 'insert', 'dic.do?p=view&moduleID=9&parentID=499');
			},
