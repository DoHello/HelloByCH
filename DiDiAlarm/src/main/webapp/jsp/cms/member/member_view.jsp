	...
	<div id="page" style='top:${model.direct==1?0:'60px'}'>
		...
		<div class="admin-content am-animation-slide-right clearfix">
			<div style="padding:20px; ">
				<h2 style="color:#353535; display:inline;">公众信息管理 » 公众信息</h2>
			</div>
			...
			<div style="padding:10px; ">
				<div class="row">
					<div class="col-md-3">
						<input type='text' id="searchText" class="form-control" placeholder="登录名">
					</div>
...
<script type="text/javascript">
	var dtGridColumns = [
		{id:'realName', title:'姓名', type:'string', columnClass:'text-center', hideType:'', fastQuery:true, fastQueryType:'eq',sortable:true,headerStyle:'background:#00a2ca;color:white;'},
...
// 		{id:'lastlogin', title:'最后登录', type:'string', columnClass:'text-center', hideType:'lg|md|sm|xs', fastQuery:true, fastQueryType:'eq'},
		{id:'telephone', title:'电话', type:'string', columnClass:'text-center', hideType:'sm|xs', fastQuery:true, fastQueryType:'eq'},
// 		{id:'company', title:'公司名称', type:'string', columnClass:'text-center', hideType:'lg|md|sm|xs', fastQuery:true, fastQueryType:'eq'},
		...
		{id:'', title:'操作', type:'string', columnClass:'text-center', columnStyle:'padding:0px;', resolution:function(value, record, column, grid, dataNo, columnNo){
			...
			content += '<c:forEach items="${model.userbutton }" var="buts"><c:if test="${buts.buttonID==\'mq\' }"><button type="button" class="btn btn-xs btn-default" onclick="eye(\''+record.userID+'\');"><i class="fa fa-eye"></i>查看</button></c:if></c:forEach>';
	...
	$('#btnSearch').on('click', function() {
		...
		sessionStorage.setItem("url","member.do?p=find");
