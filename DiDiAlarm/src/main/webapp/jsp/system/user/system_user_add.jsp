	...
	<div id="page" style='top:${model.direct==1?0:'60px'}'>
		...
		<div class="admin-content am-animation-slide-right clearfix">
			<div style="padding:20px; ">
				<h2 style="color:#353535; display:inline;">警员信息 » 新增</h2>
			...
			<div class="panel-body">
				<form id="mainForm" class="form-horizontal" role="form" method='post'>
					...
					<div class="form-group">
						...
						<div class="col-md-5" >
							<select name="companyID" id="companyID" class="chosen-select form-control" tabindex="2">
								<c:forEach items="${model.companyAll}" var="comp">
									<c:choose>
						...
						<div class="col-md-5" >
							<input type="text" name='policeNumber' id="policeNumber" placeholder="必填项" value="${model.entity.policeNumber}" class="form-control">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-5" >
							<input type="text" name='userName' id="userName"  placeholder="必填项,不可重复" value="${model.entity.userName}" class="form-control">
						</div>
						
						<label class="col-md-1 control-label">真实姓名</label>
						<div class="col-md-5" >
							<input type="text" name='realName' id="realName" placeholder="必填项" value="${model.entity.realName}" class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-5" >
							<input type="text" name='phone' id="phone" placeholder="必填项" value="${model.entity.phone}" class="form-control">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-5" >
							<input type="text" name='password' id="password"  placeholder="必填项" value="${model.entity.password}" class="form-control">
						</div>
						...
						<label class="col-md-1 control-label">巡警级别</label>
						<input class="hidden" name="policeLevel" id="policeLevel" value="${model.entity.policeLevel}">
						<div class="col-md-5" >
							<select name="policeLevelValue" id="policeLevelValue" class="chosen-select form-control" tabindex="2">
								<c:forEach items="${model.levelAll}" var="level">
									<c:choose>
										<c:when test="${ model.entity.policeLevelValue.indexOf(level.dicValue) >= 0 }">
